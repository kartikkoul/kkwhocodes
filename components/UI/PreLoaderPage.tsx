...
const PreLoaderPage = () => {
  ...
  const dotVariant: Variants = {
    animation1: { scale: [2, 1], transition: { duration: 2 } },
    animation2: {
      y: [null, -20, 0] as number[],
  ...
  const headlineVariants: Variants = {
    before: {},
    after: {
      transition: { delayChildren: 2, staggerChildren: 0.03 },
    },
  };

  const h1Variants: Variants = {
    before: { opacity: 0, y: "-2vw" },
    after: { opacity: 1, y: 0 },
  };

  const preLoaderPageVariants: Variants = {
    before: {},
    after: { transition: {} },
    exit: {
      y: -100,
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        className="fixed flex h-[90vh] w-screen flex-col justify-center overflow-hidden bg-preloader-gradient shadow-[0px_0px_42px_#fff]"
        variants={preLoaderPageVariants}
        initial="before"
        animate="after"
        exit="exit"
      >
        <div className="absolute left-16 flex flex-col">
          <motion.div
            ...
            initial="before"
            animate="after"
            className="box-border flex w-full flex-col text-base [&_h1]:font-righteous [&_h1]:font-light [&_h1]:text-[rgb(250,250,250)] [&>span]:flex [&>span]:[text-shadow:0px_0px_4px]"
          >
            <span>
          ...
          <motion.div
            ...
            initial="before"
            animate="after"
            className="flex h-full w-[50px] items-end justify-center"
          >
            <motion.svg
              variants={kVariant}
              className="h-[33px]"
